...
int main()
{
    ...
    while(1)
    {
        ...
        {
            p =first;
            P = (struct cycle *)malloc(sizeof(*P));
            P->ori = p->a;
            P->pro = FIRST->ori;
            TAIL->next = P;
            TAIL = TAIL->next;
